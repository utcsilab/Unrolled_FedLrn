...
class MCFullFastMRI(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # k_ACS_mask = np.isin(np.arange(k_image.shape[sampling_axis]),
                                  # np.hstack((center_slice_idx)))
        # k_ACS = k_image[..., k_ACS_mask]
        # Get measurements
        ...
        #find normalization constant from ACS Region Recon
        ...
        gt_ksp       = gt_ksp / norm_const#max_acs
        gt_nonzero_ksp = gt_nonzero_ksp / norm_const#max_acs
        ksp_nonzero_noise = ksp_nonzero_noise / norm_const
        # Scaled GT RSS
        ref_rss      = ref_rss / norm_const#max_acs
